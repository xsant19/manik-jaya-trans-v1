    ...
    <x-page-container class="py-12 md:py-16">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div class="md:col-span-1">
                <span class="font-bold text-xl text-carbon-black tracking-tight block mb-4">MANIK JAYA.</span>
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm text-storm-gray">
                    ...
                    <li><a href="{{ route('transfers.index') }}" class="hover:text-carbon-black transition-colors">Airport Transfer</a></li>
                    <li><a href="{{ route('shuttles.index') }}" class="hover:text-carbon-black transition-colors">Hotel Shuttle</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm text-storm-gray">
                    <li><a href="#" class="hover:text-carbon-black transition-colors">Tentang Kami</a></li>
                    <li><a href="#" class="hover:text-carbon-black transition-colors">Hubungi Kami</a></li>
                    <li><a href="#" class="hover:text-carbon-black transition-colors">Syarat & Ketentuan</a></li>
                    <li><a href="#" class="hover:text-carbon-black transition-colors">Kebijakan Privasi</a></li>
                </ul>
            </div>
