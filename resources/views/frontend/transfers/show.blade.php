...
<div class="py-12">
    <x-page-container>
        <div class="mb-6">
            <a href="{{ route('transfers.index') }}" class="text-sm font-medium text-storm-gray hover:text-carbon-black">&larr; Kembali ke Airport Transfer</a>
        </div>
        
        <div class="flex flex-col md:flex-row gap-12">
            <!-- Details -->
            <div class="flex-grow">
                <h1 class="text-4xl font-bold text-carbon-black mb-8">{{ $transfer->route_name }}</h1>
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start">
                            ...
                            <div class="flex-grow">
                                ...
                                <div class="text-lg font-bold text-carbon-black">{{ $transfer->pickup_location }}</div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="flex-grow">
                                ...
                                <div class="text-lg font-bold text-carbon-black">{{ $transfer->dropoff_location }}</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                @if($transfer->estimated_duration)
                    <div class="mb-8">
                        ...
                        <div class="flex items-center text-storm-gray">
                            ...
                            <span class="text-lg">{{ $transfer->estimated_duration }}</span>
                        </div>
                    </div>
                @endif
                
                <h3 class="text-xl font-bold text-carbon-black mb-4">Harga Transfer</h3>
                <div class="p-6 border border-soft-divider rounded-card inline-block">
                    <div class="text-sm text-storm-gray mb-1">Per Perjalanan</div>
                    <div class="text-3xl font-bold text-carbon-black">Rp {{ number_format($transfer->price, 0, ',', '.') }}</div>
                </div>
                ...
                <div class="sticky top-24 space-y-4">
                    ...
                    <div class="overflow-hidden rounded-card border border-soft-divider bg-canvas-white">
                        ...
                        <div class="border-b border-soft-divider px-6 py-5">
                            <p class="text-sm text-storm-gray">Harga per perjalanan</p>
                            <p class="mt-1 text-3xl font-bold text-carbon-black">
                                Rp {{ number_format($transfer->price, 0, ',', '.') }}
                            </p>
                        </div>
                        ...
                        <div class="divide-y divide-soft-divider px-6">
                            <div class="flex items-center justify-between py-3.5 text-sm">
                                ...
                                <span class="font-medium text-carbon-black text-right">{{ Str::limit($transfer->pickup_location, 20) }}</span>
                            </div>
                            <div class="flex items-center justify-between py-3.5 text-sm">
                                <span class="text-storm-gray">Ke</span>
                                <span class="font-medium text-carbon-black text-right">{{ Str::limit($transfer->dropoff_location, 20) }}</span>
                            </div>
                            @if($transfer->estimated_duration)
                            <div class="flex items-center justify-between py-3.5 text-sm">
                                <span class="text-storm-gray">Estimasi Waktu</span>
                                <span class="font-medium text-carbon-black">{{ $transfer->estimated_duration }}</span>
                            </div>
                            @endif
                            <div class="flex items-center justify-between py-3.5 text-sm">
                        ...
                        <div class="px-6 pb-6 pt-4">
                            @auth
                                <a href="{{ route('booking.transfers.create', $transfer) }}" class="block w-full">
                                    <button type="button"
