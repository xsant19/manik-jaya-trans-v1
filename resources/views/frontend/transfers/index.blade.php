...
<div class="py-12 bg-faint-gray border-b border-soft-divider">
    <x-page-container>
        <h1 class="text-4xl font-bold text-carbon-black mb-4">Airport Transfer</h1>
        <p class="text-storm-gray text-lg max-w-2xl">Layanan antar-jemput bandara yang nyaman dan tepat waktu. Nikmati perjalanan tanpa khawatir dengan driver profesional kami.</p>
    </x-page-container>
</div>
