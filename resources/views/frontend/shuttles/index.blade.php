...
<div class="py-16 bg-faint-gray border-b border-soft-divider">
    <x-page-container>
        <div class="max-w-3xl mx-auto text-center mb-10">
            <h1 class="text-4xl md:text-5xl font-bold text-carbon-black mb-6">Hotel Shuttle</h1>
            <p class="text-storm-gray text-lg">Layanan antar dari area hotel ke bandara yang nyaman dan tepat waktu. Nikmati perjalanan tanpa khawatir dengan driver profesional kami.</p>
        </div>

        <div class="max-w-4xl mx-auto">
            <form action="{{ route('shuttles.index') }}" method="GET" class="flex flex-col md:flex-row items-center gap-3 bg-canvas-white p-3 rounded-xl border border-soft-divider shadow-sm">
                <div class="relative flex-grow w-full">
                    ...
                    <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari nama rute atau lokasi area..." 
