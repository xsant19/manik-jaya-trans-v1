...
namespace App\Filament\Resources\RentalBookings\Tables;
        ...
        return $table
            ...
            ->columns([
                ...
                TextColumn::make('driver.name')
                    ->label('Supir')
                    ->placeholder(fn ($record) => $record?->booking_status === 'approved'
                        ? '⚠ Belum ditugaskan'
                        : '—'
                    )
                    ->color(fn ($record) => ($record?->driver_id === null && $record?->booking_status === 'approved')
                        ? 'warning'
                        : null
                    )
                    ->searchable(),
            ...
            ->recordActions([
                ...
                Action::make('approve')
                    ...
                    ->modalDescription(fn ($record) => "Booking {$record->booking_code} akan disetujui. Pastikan kendaraan tersedia.")
                ...
                Action::make('spk')
                    ...
                    ->color('info')
                    ->url(fn ($record) => route('documents.spk', ['type' => 'rental', 'id' => $record->id]))
                    ->openUrlInNewTab()
                ...
                Action::make('evoucher')
                    ...
                    ->color('success')
                    ->url(fn ($record) => route('documents.evoucher', ['type' => 'rental', 'id' => $record->id]))
                    ->openUrlInNewTab()
